...
let rec _menhir_reduce4 : _menhir_env -> ((('ttv_tail * _menhir_state) * _menhir_state * (LC.value)) * _menhir_state * (LC.value)) * _menhir_state * (LC.value) -> 'ttv_return =
...
and _menhir_reduce3 : _menhir_env -> 'ttv_tail -> _menhir_state -> (int) -> 'ttv_return =
